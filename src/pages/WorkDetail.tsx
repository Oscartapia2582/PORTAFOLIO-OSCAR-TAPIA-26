...
export default function WorkDetail() {
  ...
  return (
    ...
    >
      ...
      {/* Upper half — image or iframe embed */}
      {work.embedUrl ? (
        <ExternalEmbed url={work.embedUrl} title={work.title} />
      ) : (
        <div
          style={{
            width: '100%',
      ...
      >
        ...
        {/* iFrame Embed Demo Section — shows example embed options */}
        <div
          style={{
            marginTop: '48px',
            padding: '32px',
        ...
        >
          ...
          >
            Este proyecto puede incluir contenido embebido de Behance, Figma, Canva, Power BI, Looker Studio, Framer, Notion o Google Slides.
          </p>
          <pre
            style={{
              fontSize: '0.72rem',
